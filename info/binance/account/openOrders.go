...
type OpenOrdersContainer []SingleOpenOrder

type SingleOpenOrder struct {
	Symbol              string
	OrderId             int
	OrderListId         int
...
type OpenOrdersConf struct {
	Symbol     string `json:"symbol"`
	RecvWindow string `json:"recvWindow"`
	TimeStamp  string `json:"timeStamp"`
}

func (o *OpenOrdersContainer) RequestCompiler(conf interface{}) (*defs.CallData, error) {
	con, ok := conf.(OpenOrdersConf)
	if !ok {
...
func (o *OpenOrdersContainer) ExtractData(r io.Reader) error {
